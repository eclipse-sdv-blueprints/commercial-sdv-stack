...
fun RequestsData.addDiagnosticRequests() {
    ...
    // GET CruiseControl - MaxSpeed
    request("22 4E 35", name = "CruiseControl_MaximumSpeed_Read") {
        val ecuState = ecu.ecuState()
        val value = ecuState.cruiseControlMaximumSpeed
        ack(byteArrayOf(value.toByte()))
    }

    // SET CruiseControl - MaxSpeed
    request("2E 4E 35 .*", name = "CruiseControl_MaximumSpeed_Write") {
        val message = this.request.message
        val value: Int = message[3].toInt() and 0xFF

        val ecuState = ecu.ecuState()
        ecuState.cruiseControlMaximumSpeed = value

        println("Set CC max speed: $value")
        ack()
    }

    // GET CruiseControl - UpperDroop
    request("22 4E 36", name = "CruiseControl_UpperDroop_Read") {
        val ecuState = ecu.ecuState()
        val value = ecuState.cruiseControlUpperDroop
        ack(byteArrayOf(value.toByte()))
    }

    // SET CruiseControl - UpperDroop
    request("2E 4E 36 .*", name = "CruiseControl_UpperDroop_Write") {
        val message = this.request.message
        val value: Int = message[3].toInt() and 0xFF

        val ecuState = ecu.ecuState()
        ecuState.cruiseControlUpperDroop = value

        println("Set CC upper droop: $value")
        ack()
    }

    // GET CruiseControl - LowerDroop
    request("22 4E 37", name = "CruiseControl_LowerDroop_Read") {
        val ecuState = ecu.ecuState()
        val value = ecuState.cruiseControlLowerDroop
        ack(byteArrayOf(value.toByte()))
    }

    // SET CruiseControl - LowerDroop
    request("2E 4E 37 .*", name = "CruiseControl_LowerDroop_Write") {
        val message = this.request.message
        val value: Int = message[3].toInt() and 0xFF

        val ecuState = ecu.ecuState()
        ecuState.cruiseControlLowerDroop = value

        println("Set CC lower droop: $value")
        ack()
    }

    // GET PowerTrain - Mode
    request("22 4E 66", name = "PowerTrain_Mode_Read") {
        val ecuState = ecu.ecuState()
        val value = ecuState.powerTrainMode
        ack(byteArrayOf(value.toByte()))
    }

    // SET PowerTrain - Mode
    request("2E 4E 66 .*", name = "PowerTrain_Mode_Write") {
        val message = this.request.message
        val value: Int = message[3].toInt() and 0xFF

        val ecuState = ecu.ecuState()
        ecuState.powerTrainMode = value

        println("Set PowerTrain Mode: $value")
        ack()
    }
}
