...
data class EcuState(
    ...
    // Set of mock powertrain and cruise control profile settings
    var powerTrainMode: Int = 1,
    var cruiseControlMaximumSpeed: Int = 80,
    var cruiseControlUpperDroop: Int = 0,
    var cruiseControlLowerDroop: Int = 5,
)
